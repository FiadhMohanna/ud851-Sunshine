...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int START_RANGE_SECONDS = 3 * 3600;
    private static final int END_RANGE_SECONDS = 4 * 3600;
    private static boolean sInitialized;

//  TODO (11) Add a sync tag to identify our sync job
    private static final String WEATHER_JOB_TAG = "weather_check_tag";
//  TODO (12) Create a method to schedule our periodic weather sync
    synchronized public static void scheduleWeatherCheck(Context context){
    ...
    Job job = firebaseJobDispatcher.newJobBuilder()
            ...
            .setRecurring(true)
            .setTrigger(Trigger.executionWindow(START_RANGE_SECONDS, END_RANGE_SECONDS))
